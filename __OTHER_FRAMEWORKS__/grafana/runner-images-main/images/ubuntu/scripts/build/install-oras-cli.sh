...
download_url=$(resolve_github_release_asset_url "oras-project/oras" "endswith(\"linux_$arch.tar.gz\")" "latest")
...
external_hash=$(get_checksum_from_url "${hash_url}" "linux_$arch.tar.gz" "SHA256")

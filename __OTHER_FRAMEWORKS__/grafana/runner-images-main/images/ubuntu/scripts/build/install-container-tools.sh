...
if is_ubuntu22; then
    ...
    curl -O http://archive.ubuntu.com/ubuntu/pool/universe/g/golang-github-containernetworking-plugins/containernetworking-plugins_1.1.1+ds1-3build1_$arch.deb
    dpkg -i containernetworking-plugins_1.1.1+ds1-3build1_$arch.deb
fi

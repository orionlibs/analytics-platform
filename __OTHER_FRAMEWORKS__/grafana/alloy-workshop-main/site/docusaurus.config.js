    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/grafana/alloy-workshop/tree/main/site/',
          admonitions: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Building Telemetry Pipelines with Grafana Alloy',
        logo: {
          alt: 'Grafana Alloy Logo',
          src: 'img/alloy-icon.svg',
        },
        items: [
          {
            href: 'https://github.com/grafana/alloy-workshop',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Grafana Labs. Built with Docusaurus and 🦕.`,
      },
      prism: {

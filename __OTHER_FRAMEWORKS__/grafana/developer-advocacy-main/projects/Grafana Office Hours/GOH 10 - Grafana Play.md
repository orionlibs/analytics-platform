...
- What is Grafana Play?
	- special Grafana Cloud instance
	...
	- Data sources
		...
		- Loki
		- MySQL
		- Also those from our "competitors"-- like Influx or Elasticsearch
		- MongoDB and some enterprise plugins that are normally paywalled.
...
- Backend stuff
	...
	- How long should things be saved for?
		- Probably for about 90 days from the last modification or edit
...
- Future plans
	- What's not on Play?
		- Machine Learning is there to some degree
		- Incident AI stuff not yet there

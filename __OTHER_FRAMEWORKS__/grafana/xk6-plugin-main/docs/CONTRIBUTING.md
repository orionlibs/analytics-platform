...
Before you ask a question, it is best to search for existing [Issues](https://github.com/grafana/xk6-plugin/issues) that might help you. It is also advisable to search the internet for answers first.
...
We use [GitHub issues](https://github.com/grafana/xk6-plugin/issues) to track bugs and errors. If you run into an issue with the project:
...
- Open an [Issue](https://github.com/grafana/xk6-plugin/issues).
- Explain the behavior you would expect and the actual behavior.
- Please provide as much context as possible and describe the *reproduction steps* that someone else can follow to recreate the issue on their own.

## Suggesting Enhancements

Enhancement suggestions are tracked as [GitHub issues](https://github.com/grafana/xk6-plugin/issues).

- Make sure that you are using the latest version.
- Read the documentation carefully and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a search in [Issues](https://github.com/grafana/xk6-plugin/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.

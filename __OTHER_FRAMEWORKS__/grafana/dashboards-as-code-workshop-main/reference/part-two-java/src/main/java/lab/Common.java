...
import com.grafana.foundation.heatmap.*;
...
public class Common {
    ...
    public static com.grafana.foundation.heatmap.PanelBuilder heatmapPanel() {
        return new com.grafana.foundation.heatmap.PanelBuilder().
                ...
                filterValues(new FilterValueRangeBuilder().le(1e-09f)).

{
  ...
  forProvider+:
    {
      '#withAllowedLoadZones': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) List of allowed private k6 load zone IDs for this project.\nList of allowed private k6 load zone IDs for this project.' } },
      withAllowedLoadZones(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              allowedLoadZones:
      ...
      '#withAllowedLoadZonesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) List of allowed private k6 load zone IDs for this project.\nList of allowed private k6 load zone IDs for this project.' } },
      withAllowedLoadZonesMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              allowedLoadZones+:
      ...
      '#withProjectId': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The identifier of the project to manage private allowed load zones for.\nThe identifier of the project to manage private allowed load zones for.' } },
      withProjectId(value): {
        spec+: {
          parameters+: {
            forProvider+: {

{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ProjectAllowedLoadZonesSpec defines the desired state of ProjectAllowedLoadZones' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'ProjectAllowedLoadZonesSpec defines the desired state of ProjectAllowedLoadZones' } },

{
  ...
  forProvider+:
    {
      '#withMatchLabels': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Labels to match for this disabled alert configuration.\nLabels to match for this disabled alert configuration.' } },
      ...
      '#withMatchLabelsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Labels to match for this disabled alert configuration.\nLabels to match for this disabled alert configuration.' } },
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of the disabled alert configuration.\nThe name of the disabled alert configuration.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {

{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'SuppressedAssertionsConfigSpec defines the desired state of SuppressedAssertionsConfig' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'SuppressedAssertionsConfigSpec defines the desired state of SuppressedAssertionsConfig' } },

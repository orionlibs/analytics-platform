{
  ...
  forProvider+:
    {
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of the custom model rules.\nThe name of the custom model rules.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withRules': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Block List, Min: 1, Max: 1) The rules configuration for the custom model rules. (see below for nested schema)\nThe rules configuration for the custom model rules.' } },
      withRules(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withRulesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Block List, Min: 1, Max: 1) The rules configuration for the custom model rules. (see below for nested schema)\nThe rules configuration for the custom model rules.' } },
      ...
      rules+:
        {
          '#': { help: '', name: 'rules' },
          '#withEntity': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Block List, Min: 1) List of entities to define in the custom model rules. (see below for nested schema)\nList of entities to define in the custom model rules.' } },
          withEntity(value): {
            entity:
              (if std.isArray(value)
               then value
          ...
          '#withEntityMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Block List, Min: 1) List of entities to define in the custom model rules. (see below for nested schema)\nList of entities to define in the custom model rules.' } },
          ...
          entity+:
            {
              '#': { help: '', name: 'entity' },
              '#withDefinedBy': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Block List, Min: 1) List of queries that define this entity. (see below for nested schema)\nList of queries that define this entity.' } },
              withDefinedBy(value): {
                definedBy:
                  (if std.isArray(value)
                   then value
              ...
              '#withDefinedByMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Block List, Min: 1) List of queries that define this entity. (see below for nested schema)\nList of queries that define this entity.' } },
              ...
              definedBy+:
                {
                  '#': { help: '', name: 'definedBy' },
                  '#withDisabled': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: "(Boolean) Whether this entity is disabled.\nWhether this rule is disabled. When true, only the 'query' field is used to match an existing rule to disable; other fields are ignored." } },
                  withDisabled(value=true): {
                    disabled: value,
                  },
                  '#withLabelValues': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Label value mappings for the query.\nLabel value mappings for the query.' } },
                  withLabelValues(value): {
                    labelValues: value,
                  },
                  '#withLabelValuesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Label value mappings for the query.\nLabel value mappings for the query.' } },
                  withLabelValuesMixin(value): {
                    labelValues+: value,
                  },
                  '#withLiterals': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Literal value mappings for the query.\nLiteral value mappings for the query.' } },
                  withLiterals(value): {
                    literals: value,
                  },
                  '#withLiteralsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Literal value mappings for the query.\nLiteral value mappings for the query.' } },
                  withLiteralsMixin(value): {
                    literals+: value,
                  },
                  '#withMetricValue': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Metric value for the query.\nMetric value for the query.' } },
                  withMetricValue(value): {
                    metricValue: value,
                  },
                  '#withQuery': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The Prometheus query that defines this entity.\nThe Prometheus query that defines this entity.' } },
                  withQuery(value): {
                    query: value,
                  },
                },
              ...
              '#withEnrichedBy': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) List of enrichment sources for the entity.\nList of enrichment sources for the entity.' } },
              ...
              '#withEnrichedByMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) List of enrichment sources for the entity.\nList of enrichment sources for the entity.' } },
              ...
              '#withLookup': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Lookup mappings for the entity.\nLookup mappings for the entity.' } },
              withLookup(value): {
                lookup: value,
              },
              '#withLookupMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Lookup mappings for the entity.\nLookup mappings for the entity.' } },
              ...
              '#withScope': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Scope labels for the entity.\nScope labels for the entity.' } },
              withScope(value): {
                scope: value,
              },
              '#withScopeMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Scope labels for the entity.\nScope labels for the entity.' } },
              withScopeMixin(value): {
                scope+: value,
              },
              '#withType': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The type of the entity (e.g., Service, Pod, Namespace).\nThe type of the entity (e.g., Service, Pod, Namespace).' } },
              withType(value): {
                type: value,
              },
            },

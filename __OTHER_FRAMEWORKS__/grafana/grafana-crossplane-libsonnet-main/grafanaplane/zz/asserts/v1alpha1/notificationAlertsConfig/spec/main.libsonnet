{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'NotificationAlertsConfigSpec defines the desired state of NotificationAlertsConfig' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'NotificationAlertsConfigSpec defines the desired state of NotificationAlertsConfig' } },

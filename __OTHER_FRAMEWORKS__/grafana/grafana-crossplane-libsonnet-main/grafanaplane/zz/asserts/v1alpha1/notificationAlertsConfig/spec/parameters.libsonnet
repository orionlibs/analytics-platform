{
  ...
  forProvider+:
    {
      '#withAlertLabels': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Labels to add to alerts generated by this configuration.\nLabels to add to alerts generated by this configuration.' } },
      withAlertLabels(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              alertLabels: value,
      ...
      '#withAlertLabelsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Labels to add to alerts generated by this configuration.\nLabels to add to alerts generated by this configuration.' } },
      withAlertLabelsMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              alertLabels+: value,
      ...
      '#withDuration': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: "(String) Duration for which the condition must be true before firing (e.g., '5m', '30s'). Maps to 'for' in Asserts API.\nDuration for which the condition must be true before firing (e.g., '5m', '30s'). Maps to 'for' in Asserts API." } },
      withDuration(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withMatchLabels': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Labels to match for this alert configuration.\nLabels to match for this alert configuration.' } },
      ...
      '#withMatchLabelsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Labels to match for this alert configuration.\nLabels to match for this alert configuration.' } },
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of the alert configuration.\nThe name of the alert configuration.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withSilenced': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether this alert configuration is silenced. Defaults to false.\nWhether this alert configuration is silenced. Defaults to `false`.' } },
      withSilenced(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              silenced: value,

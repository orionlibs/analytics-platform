  ...
  forProvider+:
    {
      ...
      '#withRemoteAttributes': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Remote attributes for the collector\nRemote attributes for the collector' } },
      withRemoteAttributes(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withRemoteAttributesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) Remote attributes for the collector\nRemote attributes for the collector' } },
      withRemoteAttributesMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              remoteAttributes+: value,

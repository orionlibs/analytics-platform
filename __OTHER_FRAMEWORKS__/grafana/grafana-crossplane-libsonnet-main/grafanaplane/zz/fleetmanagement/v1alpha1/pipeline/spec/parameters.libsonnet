  ...
  forProvider+:
    {
      ...
      '#withEnabled': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether the pipeline is enabled for collectors\nWhether the pipeline is enabled for collectors' } },
      ...
      '#withMatchers': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) Used to match against collectors and assign pipelines to them; follows the syntax of Prometheus Alertmanager matchers\nUsed to match against collectors and assign pipelines to them; follows the syntax of Prometheus Alertmanager matchers' } },
      withMatchers(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withMatchersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) Used to match against collectors and assign pipelines to them; follows the syntax of Prometheus Alertmanager matchers\nUsed to match against collectors and assign pipelines to them; follows the syntax of Prometheus Alertmanager matchers' } },
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Name of the pipeline which is the unique identifier for the pipeline\nName of the pipeline which is the unique identifier for the pipeline' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {

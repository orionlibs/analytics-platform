{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'PrivateDataSourceConnectNetworkSpec defines the desired state of PrivateDataSourceConnectNetwork' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'PrivateDataSourceConnectNetworkSpec defines the desired state of PrivateDataSourceConnectNetwork' } },

{
  ...
  forProvider+:
    {
      '#withDisplayName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Display name of the PDC network. Defaults to the name.\nDisplay name of the PDC network. Defaults to the name.' } },
      ...
      '#withStackIdentifier': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The identifier of the stack.\nThe identifier of the stack.' } },
      withStackIdentifier(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              stackIdentifier: value,
            },
          },
        },
      },

{
  ...
  '#withParameters': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'K8So11YconfigV1Alpha1Spec defines the desired state of K8So11YconfigV1Alpha1' } },
  withParameters(value): {
    spec+: {
      parameters: value,
    },
  },
  '#withParametersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'K8So11YconfigV1Alpha1Spec defines the desired state of K8So11YconfigV1Alpha1' } },

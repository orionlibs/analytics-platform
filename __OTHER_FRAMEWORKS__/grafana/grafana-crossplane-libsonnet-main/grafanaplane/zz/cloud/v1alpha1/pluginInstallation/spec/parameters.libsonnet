  ...
  forProvider+:
    {
      ...
      '#withSlug': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Slug of the plugin to be installed.\nSlug of the plugin to be installed.' } },
      withSlug(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withStackSlug': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The stack id to which the plugin should be installed.\nThe stack id to which the plugin should be installed.' } },
      withStackSlug(value): {
        spec+: {
          parameters+: {
            forProvider+: {

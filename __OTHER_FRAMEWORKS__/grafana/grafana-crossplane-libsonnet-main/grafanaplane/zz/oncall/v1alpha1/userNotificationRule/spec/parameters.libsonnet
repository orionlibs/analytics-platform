  ...
  forProvider+:
    {
      ...
      '#withImportant': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Boolean value which indicates if a rule is “important”\nBoolean value which indicates if a rule is “important”' } },
      ...
      '#withUserId': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) User ID\nUser ID' } },
      withUserId(value): {
        spec+: {
          parameters+: {
            forProvider+: {

{
  ...
  forProvider+:
    {
      '#withGroups': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of String) The team external groups list\nThe team external groups list' } },
      withGroups(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withGroupsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of String) The team external groups list\nThe team external groups list' } },
      ...
      '#withTeamId': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The Team ID\nThe Team ID' } },
      withTeamId(value): {
        spec+: {
          parameters+: {
            forProvider+: {

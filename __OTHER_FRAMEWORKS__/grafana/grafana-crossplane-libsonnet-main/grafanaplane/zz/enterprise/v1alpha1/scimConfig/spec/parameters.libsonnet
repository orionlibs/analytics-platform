{
  ...
  forProvider+:
    {
      '#withEnableGroupSync': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether group synchronization is enabled.\nWhether group synchronization is enabled.' } },
      withEnableGroupSync(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withEnableUserSync': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether user synchronization is enabled.\nWhether user synchronization is enabled.' } },
      withEnableUserSync(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              enableUserSync: value,
            },
          },
        },
      },
      ...
      '#withRejectNonProvisionedUsers': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: 'provisioned user access to Grafana. Cloud Portal users will always be able to access Grafana, regardless of this setting.\nWhether to block non-provisioned user access to Grafana. Cloud Portal users will always be able to access Grafana, regardless of this setting.' } },
      withRejectNonProvisionedUsers(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              rejectNonProvisionedUsers: value,
            },
          },
        },
      },

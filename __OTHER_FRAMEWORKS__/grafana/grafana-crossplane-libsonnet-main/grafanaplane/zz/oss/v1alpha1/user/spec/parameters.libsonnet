  ...
  forProvider+:
    {
      ...
      '#withIsAdmin': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Whether to make user an admin. Defaults to false.\nWhether to make user an admin. Defaults to `false`.' } },
      withIsAdmin(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              isAdmin: value,
      ...
      '#withLogin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The username for the Grafana user.\nThe username for the Grafana user.' } },
      withLogin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The display name for the Grafana user.\nThe display name for the Grafana user.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withPasswordSecretRef': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(String, Sensitive) The password for the Grafana user.\nThe password for the Grafana user.' } },
      ...
      '#withPasswordSecretRefMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(String, Sensitive) The password for the Grafana user.\nThe password for the Grafana user.' } },

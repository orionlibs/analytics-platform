{
  ...
  forProvider+:
    {
      '#withFolderRef': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Reference to a Folder in oss to populate parentFolderUid.' } },
      withFolderRef(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withFolderRefMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Reference to a Folder in oss to populate parentFolderUid.' } },
      ...
      '#withFolderSelector': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Selector for a Folder in oss to populate parentFolderUid.' } },
      ...
      '#withFolderSelectorMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Selector for a Folder in oss to populate parentFolderUid.' } },
      ...
      '#withParentFolderUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The uid of the parent folder. If set, the folder will be nested. If not set, the folder will be created in the root folder. Note: This requires the nestedFolders feature flag to be enabled on your Grafana instance.\nThe uid of the parent folder. If set, the folder will be nested. If not set, the folder will be created in the root folder. Note: This requires the nestedFolders feature flag to be enabled on your Grafana instance.' } },
      withParentFolderUid(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              parentFolderUid: value,
            },
          },
        },
      },
      '#withPreventDestroyIfNotEmpty': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) Prevent deletion of the folder if it is not empty (contains dashboards or alert rules). This feature requires Grafana 10.2 or later. Defaults to false.\nPrevent deletion of the folder if it is not empty (contains dashboards or alert rules). This feature requires Grafana 10.2 or later. Defaults to `false`.' } },
      withPreventDestroyIfNotEmpty(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              preventDestroyIfNotEmpty: value,
            },
          },
        },
      },
      '#withTitle': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The title of the folder.\nThe title of the folder.' } },
      withTitle(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Unique identifier.\nUnique identifier.' } },
      withUid(value): {
        spec+: {
          parameters+: {
            forProvider+: {

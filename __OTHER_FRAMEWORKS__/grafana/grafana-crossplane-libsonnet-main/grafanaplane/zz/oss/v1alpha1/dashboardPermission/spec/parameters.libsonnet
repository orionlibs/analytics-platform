  ...
  forProvider+:
    {
      ...
      '#withDashboardUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) UID of the dashboard to apply permissions to.\nUID of the dashboard to apply permissions to.' } },
      ...
      permissions+:
        {
          ...
          '#withRole': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Name of the basic role to manage permissions for. Options: Viewer, Editor or Admin.\nName of the basic role to manage permissions for. Options: `Viewer`, `Editor` or `Admin`.' } },
          withRole(value): {
            role: value,
          },

  ...
  forProvider+:
    {
      ...
      '#withFolderUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Unique ID (UID) of the folder containing the library panel.\nUnique ID (UID) of the folder containing the library panel.' } },
      withFolderUid(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withModelJson': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The JSON model for the library panel.\nThe JSON model for the library panel.' } },
      withModelJson(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) Name of the library panel.\nName of the library panel.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {

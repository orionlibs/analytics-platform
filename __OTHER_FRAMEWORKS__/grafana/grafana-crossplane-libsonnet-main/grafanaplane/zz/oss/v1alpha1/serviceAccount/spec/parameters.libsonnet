{
  ...
  forProvider+:
    {
      '#withIsDisabled': { 'function': { args: [{ default: true, enums: null, name: 'value', type: ['boolean'] }], help: '(Boolean) The disabled status for the service account. Defaults to false.\nThe disabled status for the service account. Defaults to `false`.' } },
      ...
      '#withRole': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The basic role of the service account in the organization.\nThe basic role of the service account in the organization.' } },
      withRole(value): {
        spec+: {
          parameters+: {
            forProvider+: {

  ...
  forProvider+:
    {
      ...
      '#withDashboardUid': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The UID of the dashboard on which to create the annotation.\nThe UID of the dashboard on which to create the annotation.' } },
      ...
      '#withPanelId': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) The ID of the dashboard panel on which to create the annotation.\nThe ID of the dashboard panel on which to create the annotation.' } },
      withPanelId(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withTags': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of String) The tags to associate with the annotation.\nThe tags to associate with the annotation.' } },
      withTags(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withTagsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of String) The tags to associate with the annotation.\nThe tags to associate with the annotation.' } },
      withTagsMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withText': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The text to associate with the annotation.\nThe text to associate with the annotation.' } },
      withText(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withTime': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: "formatted time string indicating the annotation's time.\nThe RFC 3339-formatted time string indicating the annotation's time." } },
      withTime(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withTimeEnd': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: "formatted time string indicating the annotation's end time.\nThe RFC 3339-formatted time string indicating the annotation's end time." } },
      withTimeEnd(value): {
        spec+: {
          parameters+: {
            forProvider+: {

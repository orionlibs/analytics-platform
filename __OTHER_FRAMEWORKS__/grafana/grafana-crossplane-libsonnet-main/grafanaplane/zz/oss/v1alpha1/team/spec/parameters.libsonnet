  ...
  forProvider+:
    {
      ...
      withIgnoreExternallySyncedMembers(value=true): {
        spec+: {
          parameters+: {
            forProvider+: {
              ignoreExternallySyncedMembers: value,
            },
          },
        },
      },
      '#withMemberRefs': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'References to User in oss to populate members.' } },
      withMemberRefs(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              memberRefs:
      ...
      '#withMemberRefsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'References to User in oss to populate members.' } },
      withMemberRefsMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              memberRefs+:
      ...
      '#withMemberSelector': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Selector for a list of User in oss to populate members.' } },
      withMemberSelector(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withMemberSelectorMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Selector for a list of User in oss to populate members.' } },
      withMemberSelectorMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              memberSelector+: value,
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The display name for the Grafana team created.\nThe display name for the Grafana team created.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      teamSync+:
        {
          '#': { help: '', name: 'teamSync' },
          '#withGroups': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of String)' } },
          withGroups(value): {
            groups:
              (if std.isArray(value)
               then value
          ...
          '#withGroupsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of String)' } },

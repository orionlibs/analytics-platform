{
  ...
  forProvider+:
    {
      '#withInterval': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String)' } },
      withInterval(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of the playlist.\nThe name of the playlist.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {

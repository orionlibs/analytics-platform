{
  ...
  forProvider+:
    {
      '#withAlerts': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of Object) List of alerts for the check. (see below for nested schema)\nList of alerts for the check.' } },
      withAlerts(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withAlertsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(Set of Object) List of alerts for the check. (see below for nested schema)\nList of alerts for the check.' } },
      withAlertsMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              alerts+:
      ...
      '#withCheckId': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) The ID of the check to manage alerts for.\nThe ID of the check to manage alerts for.' } },
      withCheckId(value): {
        spec+: {
          parameters+: {
            forProvider+: {

{
  ...
  forProvider+:
    {
      '#withAllowedOrigins': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) A list of allowed origins for CORS.\nA list of allowed origins for CORS.' } },
      ...
      '#withAllowedOriginsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: '(List of String) A list of allowed origins for CORS.\nA list of allowed origins for CORS.' } },
      ...
      '#withExtraLogAttributes': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) The extra attributes to append in each signal.\nThe extra attributes to append in each signal.' } },
      withExtraLogAttributes(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              extraLogAttributes: value,
            },
          },
        },
      },
      '#withExtraLogAttributesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '(Map of String) The extra attributes to append in each signal.\nThe extra attributes to append in each signal.' } },
      withExtraLogAttributesMixin(value): {
        spec+: {
          parameters+: {
            forProvider+: {
              extraLogAttributes+: value,
      ...
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '(String) The name of Frontend Observability App.\nThe name of Frontend Observability App.' } },
      withName(value): {
        spec+: {
          parameters+: {
            forProvider+: {
      ...
      '#withStackId': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['number'] }], help: '(Number) The Stack ID of the Grafana Cloud instance.\nThe Stack ID of the Grafana Cloud instance.' } },
      withStackId(value): {
        spec+: {
          parameters+: {
            forProvider+: {

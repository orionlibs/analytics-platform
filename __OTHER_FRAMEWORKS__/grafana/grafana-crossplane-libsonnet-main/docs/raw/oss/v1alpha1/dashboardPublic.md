...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withAccessToken(value)`](#fn-specparametersforproviderwithaccesstoken)
      * [`fn withAnnotationsEnabled(value=true)`](#fn-specparametersforproviderwithannotationsenabled)
      ...
      * [`fn withIsEnabled(value=true)`](#fn-specparametersforproviderwithisenabled)
      ...
      * [`fn withShare(value)`](#fn-specparametersforproviderwithshare)
      * [`fn withTimeSelectionEnabled(value=true)`](#fn-specparametersforproviderwithtimeselectionenabled)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withAccessToken(value)`](#fn-specparametersinitproviderwithaccesstoken)
      * [`fn withAnnotationsEnabled(value=true)`](#fn-specparametersinitproviderwithannotationsenabled)
      ...
      * [`fn withIsEnabled(value=true)`](#fn-specparametersinitproviderwithisenabled)
      ...
      * [`fn withShare(value)`](#fn-specparametersinitproviderwithshare)
      * [`fn withTimeSelectionEnabled(value=true)`](#fn-specparametersinitproviderwithtimeselectionenabled)
...
###### fn spec.parameters.forProvider.withAccessToken

```jsonnet
spec.parameters.forProvider.withAccessToken(value)
```
...
###### fn spec.parameters.forProvider.withAnnotationsEnabled

```jsonnet
spec.parameters.forProvider.withAnnotationsEnabled(value=true)
```
...
###### fn spec.parameters.forProvider.withIsEnabled

```jsonnet
spec.parameters.forProvider.withIsEnabled(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withShare

```jsonnet
spec.parameters.forProvider.withShare(value)
```
...
###### fn spec.parameters.forProvider.withTimeSelectionEnabled

```jsonnet
spec.parameters.forProvider.withTimeSelectionEnabled(value=true)
```
...
###### fn spec.parameters.initProvider.withAccessToken

```jsonnet
spec.parameters.initProvider.withAccessToken(value)
```
...
(String) A public unique identifier of a public dashboard. This is used to construct its URL. It's automatically generated if not provided when creating a public dashboard.
A public unique identifier of a public dashboard. This is used to construct its URL. It's automatically generated if not provided when creating a public dashboard.
###### fn spec.parameters.initProvider.withAnnotationsEnabled

```jsonnet
spec.parameters.initProvider.withAnnotationsEnabled(value=true)
```
...
(String) The unique identifier of the original dashboard.
The unique identifier of the original dashboard.
###### fn spec.parameters.initProvider.withIsEnabled

```jsonnet
spec.parameters.initProvider.withIsEnabled(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withShare

```jsonnet
spec.parameters.initProvider.withShare(value)
```
...
(String) Set the share mode. The default value is public.
Set the share mode. The default value is `public`.
###### fn spec.parameters.initProvider.withTimeSelectionEnabled

```jsonnet
spec.parameters.initProvider.withTimeSelectionEnabled(value=true)
```

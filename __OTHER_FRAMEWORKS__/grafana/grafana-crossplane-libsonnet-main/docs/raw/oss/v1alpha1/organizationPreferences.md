...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withHomeDashboardUid(value)`](#fn-specparametersforproviderwithhomedashboarduid)
      ...
      * [`fn withTheme(value)`](#fn-specparametersforproviderwiththeme)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withHomeDashboardUid(value)`](#fn-specparametersinitproviderwithhomedashboarduid)
      ...
      * [`fn withTheme(value)`](#fn-specparametersinitproviderwiththeme)
...
###### fn spec.parameters.forProvider.withHomeDashboardUid

```jsonnet
spec.parameters.forProvider.withHomeDashboardUid(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withTheme

```jsonnet
spec.parameters.forProvider.withTheme(value)
```
...
###### fn spec.parameters.initProvider.withHomeDashboardUid

```jsonnet
spec.parameters.initProvider.withHomeDashboardUid(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withTheme

```jsonnet
spec.parameters.initProvider.withTheme(value)
```

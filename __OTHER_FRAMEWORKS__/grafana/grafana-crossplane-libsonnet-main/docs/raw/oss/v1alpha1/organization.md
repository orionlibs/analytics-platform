...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withAdminUser(value)`](#fn-specparametersforproviderwithadminuser)
      * [`fn withAdmins(value)`](#fn-specparametersforproviderwithadmins)
      * [`fn withAdminsMixin(value)`](#fn-specparametersforproviderwithadminsmixin)
      * [`fn withCreateUsers(value=true)`](#fn-specparametersforproviderwithcreateusers)
      * [`fn withEditors(value)`](#fn-specparametersforproviderwitheditors)
      * [`fn withEditorsMixin(value)`](#fn-specparametersforproviderwitheditorsmixin)
      * [`fn withName(value)`](#fn-specparametersforproviderwithname)
      * [`fn withUsersWithoutAccess(value)`](#fn-specparametersforproviderwithuserswithoutaccess)
      * [`fn withUsersWithoutAccessMixin(value)`](#fn-specparametersforproviderwithuserswithoutaccessmixin)
      * [`fn withViewers(value)`](#fn-specparametersforproviderwithviewers)
      * [`fn withViewersMixin(value)`](#fn-specparametersforproviderwithviewersmixin)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withAdminUser(value)`](#fn-specparametersinitproviderwithadminuser)
      * [`fn withAdmins(value)`](#fn-specparametersinitproviderwithadmins)
      * [`fn withAdminsMixin(value)`](#fn-specparametersinitproviderwithadminsmixin)
      * [`fn withCreateUsers(value=true)`](#fn-specparametersinitproviderwithcreateusers)
      * [`fn withEditors(value)`](#fn-specparametersinitproviderwitheditors)
      * [`fn withEditorsMixin(value)`](#fn-specparametersinitproviderwitheditorsmixin)
      * [`fn withName(value)`](#fn-specparametersinitproviderwithname)
      * [`fn withUsersWithoutAccess(value)`](#fn-specparametersinitproviderwithuserswithoutaccess)
      * [`fn withUsersWithoutAccessMixin(value)`](#fn-specparametersinitproviderwithuserswithoutaccessmixin)
      * [`fn withViewers(value)`](#fn-specparametersinitproviderwithviewers)
      * [`fn withViewersMixin(value)`](#fn-specparametersinitproviderwithviewersmixin)
...
###### fn spec.parameters.forProvider.withAdminUser

```jsonnet
spec.parameters.forProvider.withAdminUser(value)
```
...
installation. If unset, this value defaults to admin, the Grafana default.
Defaults to `admin`.
###### fn spec.parameters.forProvider.withAdmins

```jsonnet
spec.parameters.forProvider.withAdmins(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.forProvider.withAdminsMixin

```jsonnet
spec.parameters.forProvider.withAdminsMixin(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.forProvider.withCreateUsers

```jsonnet
spec.parameters.forProvider.withCreateUsers(value=true)
```
...
already exist in Grafana.
Defaults to `true`.
###### fn spec.parameters.forProvider.withEditors

```jsonnet
spec.parameters.forProvider.withEditors(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.forProvider.withEditorsMixin

```jsonnet
spec.parameters.forProvider.withEditorsMixin(value)
```
...
###### fn spec.parameters.forProvider.withUsersWithoutAccess

```jsonnet
spec.parameters.forProvider.withUsersWithoutAccess(value)
```
...
Note: users specified here must already exist in Grafana, unless 'create_users' is
set to true. This feature is only available in Grafana 10.2+.
###### fn spec.parameters.forProvider.withUsersWithoutAccessMixin

```jsonnet
spec.parameters.forProvider.withUsersWithoutAccessMixin(value)
```
...
Note: users specified here must already exist in Grafana, unless 'create_users' is
set to true. This feature is only available in Grafana 10.2+.
###### fn spec.parameters.forProvider.withViewers

```jsonnet
spec.parameters.forProvider.withViewers(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.forProvider.withViewersMixin

```jsonnet
spec.parameters.forProvider.withViewersMixin(value)
```
...
###### fn spec.parameters.initProvider.withAdminUser

```jsonnet
spec.parameters.initProvider.withAdminUser(value)
```
...
installation. If unset, this value defaults to admin, the Grafana default.
Defaults to `admin`.
###### fn spec.parameters.initProvider.withAdmins

```jsonnet
spec.parameters.initProvider.withAdmins(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.initProvider.withAdminsMixin

```jsonnet
spec.parameters.initProvider.withAdminsMixin(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.initProvider.withCreateUsers

```jsonnet
spec.parameters.initProvider.withCreateUsers(value=true)
```
...
already exist in Grafana.
Defaults to `true`.
###### fn spec.parameters.initProvider.withEditors

```jsonnet
spec.parameters.initProvider.withEditors(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.initProvider.withEditorsMixin

```jsonnet
spec.parameters.initProvider.withEditorsMixin(value)
```
...
(String) The display name for the Grafana organization created.
The display name for the Grafana organization created.
###### fn spec.parameters.initProvider.withUsersWithoutAccess

```jsonnet
spec.parameters.initProvider.withUsersWithoutAccess(value)
```
...
Note: users specified here must already exist in Grafana, unless 'create_users' is
set to true. This feature is only available in Grafana 10.2+.
###### fn spec.parameters.initProvider.withUsersWithoutAccessMixin

```jsonnet
spec.parameters.initProvider.withUsersWithoutAccessMixin(value)
```
...
Note: users specified here must already exist in Grafana, unless 'create_users' is
set to true. This feature is only available in Grafana 10.2+.
###### fn spec.parameters.initProvider.withViewers

```jsonnet
spec.parameters.initProvider.withViewers(value)
```
...
access to the organization. Note: users specified here must already exist in
Grafana unless 'create_users' is set to true.
###### fn spec.parameters.initProvider.withViewersMixin

```jsonnet
spec.parameters.initProvider.withViewersMixin(value)
```

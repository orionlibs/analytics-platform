...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withIsAdmin(value=true)`](#fn-specparametersforproviderwithisadmin)
      * [`fn withLogin(value)`](#fn-specparametersforproviderwithlogin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withIsAdmin(value=true)`](#fn-specparametersinitproviderwithisadmin)
      * [`fn withLogin(value)`](#fn-specparametersinitproviderwithlogin)
...
###### fn spec.parameters.forProvider.withIsAdmin

```jsonnet
spec.parameters.forProvider.withIsAdmin(value=true)
```
...
###### fn spec.parameters.forProvider.withLogin

```jsonnet
spec.parameters.forProvider.withLogin(value)
```
...
(String) The email address of the Grafana user.
The email address of the Grafana user.
###### fn spec.parameters.initProvider.withIsAdmin

```jsonnet
spec.parameters.initProvider.withIsAdmin(value=true)
```
...
(Boolean) Whether to make user an admin. Defaults to false.
Whether to make user an admin. Defaults to `false`.
###### fn spec.parameters.initProvider.withLogin

```jsonnet
spec.parameters.initProvider.withLogin(value)
```

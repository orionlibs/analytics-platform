...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withConfigJson(value)`](#fn-specparametersforproviderwithconfigjson)
      * [`fn withFolder(value)`](#fn-specparametersforproviderwithfolder)
      ...
      * [`fn withOverwrite(value=true)`](#fn-specparametersforproviderwithoverwrite)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withConfigJson(value)`](#fn-specparametersinitproviderwithconfigjson)
      * [`fn withFolder(value)`](#fn-specparametersinitproviderwithfolder)
      ...
      * [`fn withOverwrite(value=true)`](#fn-specparametersinitproviderwithoverwrite)
...
###### fn spec.parameters.forProvider.withConfigJson

```jsonnet
spec.parameters.forProvider.withConfigJson(value)
```
...
###### fn spec.parameters.forProvider.withFolder

```jsonnet
spec.parameters.forProvider.withFolder(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withOverwrite

```jsonnet
spec.parameters.forProvider.withOverwrite(value=true)
```
...
###### fn spec.parameters.initProvider.withConfigJson

```jsonnet
spec.parameters.initProvider.withConfigJson(value)
```
...
(String) The complete dashboard model JSON.
The complete dashboard model JSON.
###### fn spec.parameters.initProvider.withFolder

```jsonnet
spec.parameters.initProvider.withFolder(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withOverwrite

```jsonnet
spec.parameters.initProvider.withOverwrite(value=true)
```

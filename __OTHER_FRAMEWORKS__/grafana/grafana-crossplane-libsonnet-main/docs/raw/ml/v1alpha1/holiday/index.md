...
* [spec.parameters.forProvider.customPeriods](spec/parameters/forProvider/customPeriods.md)
* [spec.parameters.initProvider.customPeriods](spec/parameters/initProvider/customPeriods.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withCustomPeriods(value)`](#fn-specparametersforproviderwithcustomperiods)
      * [`fn withCustomPeriodsMixin(value)`](#fn-specparametersforproviderwithcustomperiodsmixin)
      * [`fn withDescription(value)`](#fn-specparametersforproviderwithdescription)
      * [`fn withIcalTimezone(value)`](#fn-specparametersforproviderwithicaltimezone)
      * [`fn withIcalUrl(value)`](#fn-specparametersforproviderwithicalurl)
      * [`fn withName(value)`](#fn-specparametersforproviderwithname)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withCustomPeriods(value)`](#fn-specparametersinitproviderwithcustomperiods)
      * [`fn withCustomPeriodsMixin(value)`](#fn-specparametersinitproviderwithcustomperiodsmixin)
      * [`fn withDescription(value)`](#fn-specparametersinitproviderwithdescription)
      * [`fn withIcalTimezone(value)`](#fn-specparametersinitproviderwithicaltimezone)
      * [`fn withIcalUrl(value)`](#fn-specparametersinitproviderwithicalurl)
...
###### fn spec.parameters.forProvider.withCustomPeriods

```jsonnet
spec.parameters.forProvider.withCustomPeriods(value)
```
...
###### fn spec.parameters.forProvider.withCustomPeriodsMixin

```jsonnet
spec.parameters.forProvider.withCustomPeriodsMixin(value)
```
...
###### fn spec.parameters.forProvider.withIcalTimezone

```jsonnet
spec.parameters.forProvider.withIcalTimezone(value)
```
...
###### fn spec.parameters.forProvider.withIcalUrl

```jsonnet
spec.parameters.forProvider.withIcalUrl(value)
```
...
###### fn spec.parameters.initProvider.withCustomPeriods

```jsonnet
spec.parameters.initProvider.withCustomPeriods(value)
```
...
A list of custom periods for the holiday.
###### fn spec.parameters.initProvider.withCustomPeriodsMixin

```jsonnet
spec.parameters.initProvider.withCustomPeriodsMixin(value)
```
...
A description of the holiday.
###### fn spec.parameters.initProvider.withIcalTimezone

```jsonnet
spec.parameters.initProvider.withIcalTimezone(value)
```
...
The timezone to use for events in the iCal file pointed to by ical_url.
###### fn spec.parameters.initProvider.withIcalUrl

```jsonnet
spec.parameters.initProvider.withIcalUrl(value)
```

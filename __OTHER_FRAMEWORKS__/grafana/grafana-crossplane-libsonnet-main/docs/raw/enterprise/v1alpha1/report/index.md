...
* [spec.parameters.forProvider.dashboards](spec/parameters/forProvider/dashboards/index.md)
* [spec.parameters.forProvider.schedule](spec/parameters/forProvider/schedule.md)
* [spec.parameters.initProvider.dashboards](spec/parameters/initProvider/dashboards/index.md)
* [spec.parameters.initProvider.schedule](spec/parameters/initProvider/schedule.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withDashboards(value)`](#fn-specparametersforproviderwithdashboards)
      * [`fn withDashboardsMixin(value)`](#fn-specparametersforproviderwithdashboardsmixin)
      * [`fn withFormats(value)`](#fn-specparametersforproviderwithformats)
      * [`fn withFormatsMixin(value)`](#fn-specparametersforproviderwithformatsmixin)
      * [`fn withIncludeDashboardLink(value=true)`](#fn-specparametersforproviderwithincludedashboardlink)
      * [`fn withIncludeTableCsv(value=true)`](#fn-specparametersforproviderwithincludetablecsv)
      * [`fn withLayout(value)`](#fn-specparametersforproviderwithlayout)
      * [`fn withMessage(value)`](#fn-specparametersforproviderwithmessage)
      ...
      * [`fn withOrientation(value)`](#fn-specparametersforproviderwithorientation)
      * [`fn withRecipients(value)`](#fn-specparametersforproviderwithrecipients)
      * [`fn withRecipientsMixin(value)`](#fn-specparametersforproviderwithrecipientsmixin)
      * [`fn withReplyTo(value)`](#fn-specparametersforproviderwithreplyto)
      * [`fn withSchedule(value)`](#fn-specparametersforproviderwithschedule)
      * [`fn withScheduleMixin(value)`](#fn-specparametersforproviderwithschedulemixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withDashboards(value)`](#fn-specparametersinitproviderwithdashboards)
      * [`fn withDashboardsMixin(value)`](#fn-specparametersinitproviderwithdashboardsmixin)
      * [`fn withFormats(value)`](#fn-specparametersinitproviderwithformats)
      * [`fn withFormatsMixin(value)`](#fn-specparametersinitproviderwithformatsmixin)
      * [`fn withIncludeDashboardLink(value=true)`](#fn-specparametersinitproviderwithincludedashboardlink)
      * [`fn withIncludeTableCsv(value=true)`](#fn-specparametersinitproviderwithincludetablecsv)
      * [`fn withLayout(value)`](#fn-specparametersinitproviderwithlayout)
      * [`fn withMessage(value)`](#fn-specparametersinitproviderwithmessage)
      ...
      * [`fn withOrientation(value)`](#fn-specparametersinitproviderwithorientation)
      * [`fn withRecipients(value)`](#fn-specparametersinitproviderwithrecipients)
      * [`fn withRecipientsMixin(value)`](#fn-specparametersinitproviderwithrecipientsmixin)
      * [`fn withReplyTo(value)`](#fn-specparametersinitproviderwithreplyto)
      * [`fn withSchedule(value)`](#fn-specparametersinitproviderwithschedule)
      * [`fn withScheduleMixin(value)`](#fn-specparametersinitproviderwithschedulemixin)
...
###### fn spec.parameters.forProvider.withDashboards

```jsonnet
spec.parameters.forProvider.withDashboards(value)
```
...
###### fn spec.parameters.forProvider.withDashboardsMixin

```jsonnet
spec.parameters.forProvider.withDashboardsMixin(value)
```
...
(Block List) List of dashboards to render into the report (see below for nested schema)
List of dashboards to render into the report
###### fn spec.parameters.forProvider.withFormats

```jsonnet
spec.parameters.forProvider.withFormats(value)
```
...
###### fn spec.parameters.forProvider.withFormatsMixin

```jsonnet
spec.parameters.forProvider.withFormatsMixin(value)
```
...
(Set of String) Specifies what kind of attachment to generate for the report. Allowed values: pdf, csv, image.
Specifies what kind of attachment to generate for the report. Allowed values: `pdf`, `csv`, `image`.
###### fn spec.parameters.forProvider.withIncludeDashboardLink

```jsonnet
spec.parameters.forProvider.withIncludeDashboardLink(value=true)
```
...
```jsonnet
spec.parameters.forProvider.withIncludeTableCsv(value=true)
```
...
```jsonnet
spec.parameters.forProvider.withLayout(value)
```
...
```jsonnet
spec.parameters.forProvider.withMessage(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withOrientation

```jsonnet
spec.parameters.forProvider.withOrientation(value)
```
...
```jsonnet
spec.parameters.forProvider.withRecipients(value)
```
...
###### fn spec.parameters.forProvider.withRecipientsMixin

```jsonnet
spec.parameters.forProvider.withRecipientsMixin(value)
```
...
(List of String) List of recipients of the report.
List of recipients of the report.
###### fn spec.parameters.forProvider.withReplyTo

```jsonnet
spec.parameters.forProvider.withReplyTo(value)
```
...
###### fn spec.parameters.forProvider.withSchedule

```jsonnet
spec.parameters.forProvider.withSchedule(value)
```
...
```jsonnet
spec.parameters.forProvider.withScheduleMixin(value)
```
...
###### fn spec.parameters.initProvider.withDashboards

```jsonnet
spec.parameters.initProvider.withDashboards(value)
```
...
(Block List) List of dashboards to render into the report (see below for nested schema)
List of dashboards to render into the report
###### fn spec.parameters.initProvider.withDashboardsMixin

```jsonnet
spec.parameters.initProvider.withDashboardsMixin(value)
```
...
(Block List) List of dashboards to render into the report (see below for nested schema)
List of dashboards to render into the report
###### fn spec.parameters.initProvider.withFormats

```jsonnet
spec.parameters.initProvider.withFormats(value)
```
...
(Set of String) Specifies what kind of attachment to generate for the report. Allowed values: pdf, csv, image.
Specifies what kind of attachment to generate for the report. Allowed values: `pdf`, `csv`, `image`.
###### fn spec.parameters.initProvider.withFormatsMixin

```jsonnet
spec.parameters.initProvider.withFormatsMixin(value)
```
...
(Set of String) Specifies what kind of attachment to generate for the report. Allowed values: pdf, csv, image.
Specifies what kind of attachment to generate for the report. Allowed values: `pdf`, `csv`, `image`.
###### fn spec.parameters.initProvider.withIncludeDashboardLink

```jsonnet
spec.parameters.initProvider.withIncludeDashboardLink(value=true)
```
...
```jsonnet
spec.parameters.initProvider.withIncludeTableCsv(value=true)
```
...
```jsonnet
spec.parameters.initProvider.withLayout(value)
```
...
```jsonnet
spec.parameters.initProvider.withMessage(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withOrientation

```jsonnet
spec.parameters.initProvider.withOrientation(value)
```
...
```jsonnet
spec.parameters.initProvider.withRecipients(value)
```
...
(List of String) List of recipients of the report.
List of recipients of the report.
###### fn spec.parameters.initProvider.withRecipientsMixin

```jsonnet
spec.parameters.initProvider.withRecipientsMixin(value)
```
...
(List of String) List of recipients of the report.
List of recipients of the report.
###### fn spec.parameters.initProvider.withReplyTo

```jsonnet
spec.parameters.initProvider.withReplyTo(value)
```
...
to email address of the report.
Reply-to email address of the report.
###### fn spec.parameters.initProvider.withSchedule

```jsonnet
spec.parameters.initProvider.withSchedule(value)
```
...
```jsonnet
spec.parameters.initProvider.withScheduleMixin(value)
```

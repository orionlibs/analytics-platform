...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withEnableGroupSync(value=true)`](#fn-specparametersforproviderwithenablegroupsync)
      * [`fn withEnableUserSync(value=true)`](#fn-specparametersforproviderwithenableusersync)
      ...
      * [`fn withRejectNonProvisionedUsers(value=true)`](#fn-specparametersforproviderwithrejectnonprovisionedusers)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withEnableGroupSync(value=true)`](#fn-specparametersinitproviderwithenablegroupsync)
      * [`fn withEnableUserSync(value=true)`](#fn-specparametersinitproviderwithenableusersync)
      ...
      * [`fn withRejectNonProvisionedUsers(value=true)`](#fn-specparametersinitproviderwithrejectnonprovisionedusers)
...
###### fn spec.parameters.forProvider.withEnableGroupSync

```jsonnet
spec.parameters.forProvider.withEnableGroupSync(value=true)
```
...
###### fn spec.parameters.forProvider.withEnableUserSync

```jsonnet
spec.parameters.forProvider.withEnableUserSync(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withRejectNonProvisionedUsers

```jsonnet
spec.parameters.forProvider.withRejectNonProvisionedUsers(value=true)
```
...
###### fn spec.parameters.initProvider.withEnableGroupSync

```jsonnet
spec.parameters.initProvider.withEnableGroupSync(value=true)
```
...
(Boolean) Whether group synchronization is enabled.
Whether group synchronization is enabled.
###### fn spec.parameters.initProvider.withEnableUserSync

```jsonnet
spec.parameters.initProvider.withEnableUserSync(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withRejectNonProvisionedUsers

```jsonnet
spec.parameters.initProvider.withRejectNonProvisionedUsers(value=true)
```

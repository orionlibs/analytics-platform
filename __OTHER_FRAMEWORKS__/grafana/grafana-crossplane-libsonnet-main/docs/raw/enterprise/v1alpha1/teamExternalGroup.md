...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withGroups(value)`](#fn-specparametersforproviderwithgroups)
      * [`fn withGroupsMixin(value)`](#fn-specparametersforproviderwithgroupsmixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withGroups(value)`](#fn-specparametersinitproviderwithgroups)
      * [`fn withGroupsMixin(value)`](#fn-specparametersinitproviderwithgroupsmixin)
...
###### fn spec.parameters.forProvider.withGroups

```jsonnet
spec.parameters.forProvider.withGroups(value)
```
...
###### fn spec.parameters.forProvider.withGroupsMixin

```jsonnet
spec.parameters.forProvider.withGroupsMixin(value)
```
...
###### fn spec.parameters.initProvider.withGroups

```jsonnet
spec.parameters.initProvider.withGroups(value)
```
...
(Set of String) The team external groups list
The team external groups list
###### fn spec.parameters.initProvider.withGroupsMixin

```jsonnet
spec.parameters.initProvider.withGroupsMixin(value)
```

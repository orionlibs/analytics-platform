...
* [spec.parameters.forProvider.permissions](spec/parameters/forProvider/permissions.md)
* [spec.parameters.initProvider.permissions](spec/parameters/initProvider/permissions.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withAutoIncrementVersion(value=true)`](#fn-specparametersforproviderwithautoincrementversion)
      ...
      * [`fn withGlobal(value=true)`](#fn-specparametersforproviderwithglobal)
      * [`fn withGroup(value)`](#fn-specparametersforproviderwithgroup)
      * [`fn withHidden(value=true)`](#fn-specparametersforproviderwithhidden)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withAutoIncrementVersion(value=true)`](#fn-specparametersinitproviderwithautoincrementversion)
      ...
      * [`fn withGlobal(value=true)`](#fn-specparametersinitproviderwithglobal)
      * [`fn withGroup(value)`](#fn-specparametersinitproviderwithgroup)
      * [`fn withHidden(value=true)`](#fn-specparametersinitproviderwithhidden)
...
###### fn spec.parameters.forProvider.withAutoIncrementVersion

```jsonnet
spec.parameters.forProvider.withAutoIncrementVersion(value=true)
```
...
###### fn spec.parameters.forProvider.withGlobal

```jsonnet
spec.parameters.forProvider.withGlobal(value=true)
```
...
###### fn spec.parameters.forProvider.withGroup

```jsonnet
spec.parameters.forProvider.withGroup(value)
```
...
###### fn spec.parameters.forProvider.withHidden

```jsonnet
spec.parameters.forProvider.withHidden(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withPermissions

```jsonnet
spec.parameters.forProvider.withPermissions(value)
```
...
###### fn spec.parameters.forProvider.withPermissionsMixin

```jsonnet
spec.parameters.forProvider.withPermissionsMixin(value)
```
...
###### fn spec.parameters.initProvider.withAutoIncrementVersion

```jsonnet
spec.parameters.initProvider.withAutoIncrementVersion(value=true)
```
...
(String) Display name of the role. Available with Grafana 8.5+.
Display name of the role. Available with Grafana 8.5+.
###### fn spec.parameters.initProvider.withGlobal

```jsonnet
spec.parameters.initProvider.withGlobal(value=true)
```
...
(Boolean) Boolean to state whether the role is available across all organizations or not. Defaults to false.
Boolean to state whether the role is available across all organizations or not. Defaults to `false`.
###### fn spec.parameters.initProvider.withGroup

```jsonnet
spec.parameters.initProvider.withGroup(value)
```
...
(String) Group of the role. Available with Grafana 8.5+.
Group of the role. Available with Grafana 8.5+.
###### fn spec.parameters.initProvider.withHidden

```jsonnet
spec.parameters.initProvider.withHidden(value=true)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withPermissions

```jsonnet
spec.parameters.initProvider.withPermissions(value)
```
...
(Block Set) Specific set of actions granted by the role. (see below for nested schema)
Specific set of actions granted by the role.
###### fn spec.parameters.initProvider.withPermissionsMixin

```jsonnet
spec.parameters.initProvider.withPermissionsMixin(value)
```

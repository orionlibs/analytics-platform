...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withEntityPropertyToLogLabelMapping(value)`](#fn-specparametersforproviderwithentitypropertytologlabelmapping)
      * [`fn withEntityPropertyToLogLabelMappingMixin(value)`](#fn-specparametersforproviderwithentitypropertytologlabelmappingmixin)
      * [`fn withErrorLabel(value)`](#fn-specparametersforproviderwitherrorlabel)
      * [`fn withFilterBySpanId(value=true)`](#fn-specparametersforproviderwithfilterbyspanid)
      * [`fn withFilterByTraceId(value=true)`](#fn-specparametersforproviderwithfilterbytraceid)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withEntityPropertyToLogLabelMapping(value)`](#fn-specparametersinitproviderwithentitypropertytologlabelmapping)
      * [`fn withEntityPropertyToLogLabelMappingMixin(value)`](#fn-specparametersinitproviderwithentitypropertytologlabelmappingmixin)
      * [`fn withErrorLabel(value)`](#fn-specparametersinitproviderwitherrorlabel)
      * [`fn withFilterBySpanId(value=true)`](#fn-specparametersinitproviderwithfilterbyspanid)
      * [`fn withFilterByTraceId(value=true)`](#fn-specparametersinitproviderwithfilterbytraceid)
...
###### fn spec.parameters.forProvider.withEntityPropertyToLogLabelMapping

```jsonnet
spec.parameters.forProvider.withEntityPropertyToLogLabelMapping(value)
```
...
###### fn spec.parameters.forProvider.withEntityPropertyToLogLabelMappingMixin

```jsonnet
spec.parameters.forProvider.withEntityPropertyToLogLabelMappingMixin(value)
```
...
(Map of String) Mapping of entity properties to log labels.
Mapping of entity properties to log labels.
###### fn spec.parameters.forProvider.withErrorLabel

```jsonnet
spec.parameters.forProvider.withErrorLabel(value)
```
...
###### fn spec.parameters.forProvider.withFilterBySpanId

```jsonnet
spec.parameters.forProvider.withFilterBySpanId(value=true)
```
...
###### fn spec.parameters.forProvider.withFilterByTraceId

```jsonnet
spec.parameters.forProvider.withFilterByTraceId(value=true)
```
...
(Boolean) Is it the default config, therefore undeletable?
Is it the default config, therefore undeletable?
###### fn spec.parameters.initProvider.withEntityPropertyToLogLabelMapping

```jsonnet
spec.parameters.initProvider.withEntityPropertyToLogLabelMapping(value)
```
...
(Map of String) Mapping of entity properties to log labels.
Mapping of entity properties to log labels.
###### fn spec.parameters.initProvider.withEntityPropertyToLogLabelMappingMixin

```jsonnet
spec.parameters.initProvider.withEntityPropertyToLogLabelMappingMixin(value)
```
...
(Map of String) Mapping of entity properties to log labels.
Mapping of entity properties to log labels.
###### fn spec.parameters.initProvider.withErrorLabel

```jsonnet
spec.parameters.initProvider.withErrorLabel(value)
```
...
(String) Error label to filter logs.
Error label to filter logs.
###### fn spec.parameters.initProvider.withFilterBySpanId

```jsonnet
spec.parameters.initProvider.withFilterBySpanId(value=true)
```
...
(Boolean) Filter logs by span ID.
Filter logs by span ID.
###### fn spec.parameters.initProvider.withFilterByTraceId

```jsonnet
spec.parameters.initProvider.withFilterByTraceId(value=true)
```

...
* [spec.parameters.forProvider.rules](spec/parameters/forProvider/rules/index.md)
* [spec.parameters.initProvider.rules](spec/parameters/initProvider/rules/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withRulesMixin(value)`](#fn-specparametersforproviderwithrulesmixin)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withRulesMixin(value)`](#fn-specparametersinitproviderwithrulesmixin)
...
###### fn spec.parameters.forProvider.withRulesMixin

```jsonnet
spec.parameters.forProvider.withRulesMixin(value)
```
...
(Block List, Min: 1, Max: 1) The rules configuration for the custom model rules. (see below for nested schema)
The rules configuration for the custom model rules.
###### fn spec.parameters.initProvider.withRulesMixin

```jsonnet
spec.parameters.initProvider.withRulesMixin(value)
```

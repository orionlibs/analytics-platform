...
* [spec.parameters.forProvider.defaultRoute](spec/parameters/forProvider/defaultRoute/index.md)
* [spec.parameters.forProvider.templates](spec/parameters/forProvider/templates/index.md)
* [spec.parameters.initProvider.defaultRoute](spec/parameters/initProvider/defaultRoute/index.md)
* [spec.parameters.initProvider.templates](spec/parameters/initProvider/templates/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withTemplatesMixin(value)`](#fn-specparametersforproviderwithtemplatesmixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withTemplatesMixin(value)`](#fn-specparametersinitproviderwithtemplatesmixin)
...
###### fn spec.parameters.forProvider.withDefaultRoute

```jsonnet
spec.parameters.forProvider.withDefaultRoute(value)
```
...
###### fn spec.parameters.forProvider.withDefaultRouteMixin

```jsonnet
spec.parameters.forProvider.withDefaultRouteMixin(value)
```
...
```jsonnet
spec.parameters.forProvider.withTemplates(value)
```
...
###### fn spec.parameters.forProvider.withTemplatesMixin

```jsonnet
spec.parameters.forProvider.withTemplatesMixin(value)
```
...
###### fn spec.parameters.initProvider.withDefaultRoute

```jsonnet
spec.parameters.initProvider.withDefaultRoute(value)
```
...
(Block List, Min: 1, Max: 1) The Default route for all alerts from the given integration (see below for nested schema)
The Default route for all alerts from the given integration
###### fn spec.parameters.initProvider.withDefaultRouteMixin

```jsonnet
spec.parameters.initProvider.withDefaultRouteMixin(value)
```
...
```jsonnet
spec.parameters.initProvider.withTemplates(value)
```
...
(Block List, Max: 1) Jinja2 templates for Alert payload. An empty templates block will be ignored. (see below for nested schema)
Jinja2 templates for Alert payload. An empty templates block will be ignored.
###### fn spec.parameters.initProvider.withTemplatesMixin

```jsonnet
spec.parameters.initProvider.withTemplatesMixin(value)
```

...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withAllowedLoadZones(value)`](#fn-specparametersforproviderwithallowedloadzones)
      * [`fn withAllowedLoadZonesMixin(value)`](#fn-specparametersforproviderwithallowedloadzonesmixin)
      * [`fn withProjectId(value)`](#fn-specparametersforproviderwithprojectid)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withAllowedLoadZones(value)`](#fn-specparametersinitproviderwithallowedloadzones)
      * [`fn withAllowedLoadZonesMixin(value)`](#fn-specparametersinitproviderwithallowedloadzonesmixin)
...
###### fn spec.parameters.forProvider.withAllowedLoadZones

```jsonnet
spec.parameters.forProvider.withAllowedLoadZones(value)
```
...
###### fn spec.parameters.forProvider.withAllowedLoadZonesMixin

```jsonnet
spec.parameters.forProvider.withAllowedLoadZonesMixin(value)
```
...
###### fn spec.parameters.initProvider.withAllowedLoadZones

```jsonnet
spec.parameters.initProvider.withAllowedLoadZones(value)
```
...
(List of String) List of allowed private k6 load zone IDs for this project.
List of allowed private k6 load zone IDs for this project.
###### fn spec.parameters.initProvider.withAllowedLoadZonesMixin

```jsonnet
spec.parameters.initProvider.withAllowedLoadZonesMixin(value)
```

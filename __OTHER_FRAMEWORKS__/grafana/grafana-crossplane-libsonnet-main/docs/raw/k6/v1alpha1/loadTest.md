...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withBaselineTestRunId(value)`](#fn-specparametersforproviderwithbaselinetestrunid)
      ...
      * [`fn withScript(value)`](#fn-specparametersforproviderwithscript)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withBaselineTestRunId(value)`](#fn-specparametersinitproviderwithbaselinetestrunid)
      ...
      * [`fn withScript(value)`](#fn-specparametersinitproviderwithscript)
...
###### fn spec.parameters.forProvider.withBaselineTestRunId

```jsonnet
spec.parameters.forProvider.withBaselineTestRunId(value)
```
...
Selector for a Project in k6 to populate projectId.
###### fn spec.parameters.forProvider.withScript

```jsonnet
spec.parameters.forProvider.withScript(value)
```
...
###### fn spec.parameters.initProvider.withBaselineTestRunId

```jsonnet
spec.parameters.initProvider.withBaselineTestRunId(value)
```
...
Selector for a Project in k6 to populate projectId.
###### fn spec.parameters.initProvider.withScript

```jsonnet
spec.parameters.initProvider.withScript(value)
```

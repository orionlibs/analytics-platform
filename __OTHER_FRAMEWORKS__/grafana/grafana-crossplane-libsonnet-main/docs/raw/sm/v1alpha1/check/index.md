...
* [spec.parameters.forProvider.settings](spec/parameters/forProvider/settings/index.md)
* [spec.parameters.initProvider.settings](spec/parameters/initProvider/settings/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withSettingsMixin(value)`](#fn-specparametersforproviderwithsettingsmixin)
      * [`fn withTarget(value)`](#fn-specparametersforproviderwithtarget)
      * [`fn withTimeout(value)`](#fn-specparametersforproviderwithtimeout)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withSettingsMixin(value)`](#fn-specparametersinitproviderwithsettingsmixin)
      * [`fn withTarget(value)`](#fn-specparametersinitproviderwithtarget)
      * [`fn withTimeout(value)`](#fn-specparametersinitproviderwithtimeout)
...
###### fn spec.parameters.forProvider.withAlertSensitivity

```jsonnet
spec.parameters.forProvider.withAlertSensitivity(value)
```
...
###### fn spec.parameters.forProvider.withBasicMetricsOnly

```jsonnet
spec.parameters.forProvider.withBasicMetricsOnly(value=true)
```
...
###### fn spec.parameters.forProvider.withJob

```jsonnet
spec.parameters.forProvider.withJob(value)
```
...
```jsonnet
spec.parameters.forProvider.withProbes(value)
```
...
###### fn spec.parameters.forProvider.withProbesMixin

```jsonnet
spec.parameters.forProvider.withProbesMixin(value)
```
...
(Set of Number) List of probe location IDs where this target will be checked from.
List of probe location IDs where this target will be checked from.
###### fn spec.parameters.forProvider.withSettings

```jsonnet
spec.parameters.forProvider.withSettings(value)
```
...
```jsonnet
spec.parameters.forProvider.withSettingsMixin(value)
```
...
(Block Set, Min: 1, Max: 1) Check settings. Should contain exactly one nested block. (see below for nested schema)
Check settings. Should contain exactly one nested block.
###### fn spec.parameters.forProvider.withTarget

```jsonnet
spec.parameters.forProvider.withTarget(value)
```
...
Hostname to ping.
###### fn spec.parameters.forProvider.withTimeout

```jsonnet
spec.parameters.forProvider.withTimeout(value)
```
...
###### fn spec.parameters.initProvider.withAlertSensitivity

```jsonnet
spec.parameters.initProvider.withAlertSensitivity(value)
```
...
(String) Can be set to none, low, medium, or high to correspond to the check alert levels. Defaults to none.
Can be set to `none`, `low`, `medium`, or `high` to correspond to the check [alert levels](https://grafana.com/docs/grafana-cloud/testing/synthetic-monitoring/configure-alerts/synthetic-monitoring-alerting/). Defaults to `none`.
###### fn spec.parameters.initProvider.withBasicMetricsOnly

```jsonnet
spec.parameters.initProvider.withBasicMetricsOnly(value=true)
```
...
(Number) How often the check runs in milliseconds (the value is not truly a "frequency" but a "period"). The minimum acceptable value is 1 second (1000 ms), and the maximum is 1 hour (3600000 ms). Defaults to 60000.
How often the check runs in milliseconds (the value is not truly a "frequency" but a "period"). The minimum acceptable value is 1 second (1000 ms), and the maximum is 1 hour (3600000 ms). Defaults to `60000`.
###### fn spec.parameters.initProvider.withJob

```jsonnet
spec.parameters.initProvider.withJob(value)
```
...
```jsonnet
spec.parameters.initProvider.withProbes(value)
```
...
(Set of Number) List of probe location IDs where this target will be checked from.
List of probe location IDs where this target will be checked from.
###### fn spec.parameters.initProvider.withProbesMixin

```jsonnet
spec.parameters.initProvider.withProbesMixin(value)
```
...
(Set of Number) List of probe location IDs where this target will be checked from.
List of probe location IDs where this target will be checked from.
###### fn spec.parameters.initProvider.withSettings

```jsonnet
spec.parameters.initProvider.withSettings(value)
```
...
```jsonnet
spec.parameters.initProvider.withSettingsMixin(value)
```
...
(Block Set, Min: 1, Max: 1) Check settings. Should contain exactly one nested block. (see below for nested schema)
Check settings. Should contain exactly one nested block.
###### fn spec.parameters.initProvider.withTarget

```jsonnet
spec.parameters.initProvider.withTarget(value)
```
...
(String) Hostname to ping.
Hostname to ping.
###### fn spec.parameters.initProvider.withTimeout

```jsonnet
spec.parameters.initProvider.withTimeout(value)
```

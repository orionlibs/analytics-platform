...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withLatitude(value)`](#fn-specparametersforproviderwithlatitude)
      * [`fn withLongitude(value)`](#fn-specparametersforproviderwithlongitude)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withLatitude(value)`](#fn-specparametersinitproviderwithlatitude)
      * [`fn withLongitude(value)`](#fn-specparametersinitproviderwithlongitude)
      * [`fn withName(value)`](#fn-specparametersinitproviderwithname)
      * [`fn withPublic(value=true)`](#fn-specparametersinitproviderwithpublic)
...
```jsonnet
spec.parameters.forProvider.withDisableScriptedChecks(value=true)
```
...
```jsonnet
spec.parameters.forProvider.withLatitude(value)
```
...
###### fn spec.parameters.forProvider.withLongitude

```jsonnet
spec.parameters.forProvider.withLongitude(value)
```
...
Name of the probe.
###### fn spec.parameters.forProvider.withPublic

```jsonnet
spec.parameters.forProvider.withPublic(value=true)
```
...
```jsonnet
spec.parameters.initProvider.withDisableScriptedChecks(value=true)
```
...
```jsonnet
spec.parameters.initProvider.withLatitude(value)
```
...
(Number) Latitude coordinates.
Latitude coordinates.
###### fn spec.parameters.initProvider.withLongitude

```jsonnet
spec.parameters.initProvider.withLongitude(value)
```
...
(String) Name of the probe.
Name of the probe.
###### fn spec.parameters.initProvider.withPublic

```jsonnet
spec.parameters.initProvider.withPublic(value=true)
```

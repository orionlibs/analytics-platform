...
* [spec.parameters.forProvider.alerts](spec/parameters/forProvider/alerts.md)
* [spec.parameters.initProvider.alerts](spec/parameters/initProvider/alerts.md)
...
###### fn spec.parameters.forProvider.withAlerts

```jsonnet
spec.parameters.forProvider.withAlerts(value)
```
...
###### fn spec.parameters.forProvider.withAlertsMixin

```jsonnet
spec.parameters.forProvider.withAlertsMixin(value)
```
...
(Set of Object) List of alerts for the check. (see below for nested schema)
List of alerts for the check.
###### fn spec.parameters.forProvider.withCheckId

```jsonnet
spec.parameters.forProvider.withCheckId(value)
```
...
###### fn spec.parameters.initProvider.withAlerts

```jsonnet
spec.parameters.initProvider.withAlerts(value)
```
...
(Set of Object) List of alerts for the check. (see below for nested schema)
List of alerts for the check.
###### fn spec.parameters.initProvider.withAlertsMixin

```jsonnet
spec.parameters.initProvider.withAlertsMixin(value)
```
...
(Set of Object) List of alerts for the check. (see below for nested schema)
List of alerts for the check.
###### fn spec.parameters.initProvider.withCheckId

```jsonnet
spec.parameters.initProvider.withCheckId(value)
```

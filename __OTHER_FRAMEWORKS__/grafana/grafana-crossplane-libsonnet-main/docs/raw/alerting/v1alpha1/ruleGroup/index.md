...
* [spec.parameters.forProvider.rule](spec/parameters/forProvider/rule/index.md)
* [spec.parameters.initProvider.rule](spec/parameters/initProvider/rule/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withIntervalSeconds(value)`](#fn-specparametersforproviderwithintervalseconds)
      ...
      * [`fn withRule(value)`](#fn-specparametersforproviderwithrule)
      * [`fn withRuleMixin(value)`](#fn-specparametersforproviderwithrulemixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withIntervalSeconds(value)`](#fn-specparametersinitproviderwithintervalseconds)
      ...
      * [`fn withRule(value)`](#fn-specparametersinitproviderwithrule)
      * [`fn withRuleMixin(value)`](#fn-specparametersinitproviderwithrulemixin)
...
###### fn spec.parameters.forProvider.withIntervalSeconds

```jsonnet
spec.parameters.forProvider.withIntervalSeconds(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.forProvider.withRule

```jsonnet
spec.parameters.forProvider.withRule(value)
```
...
###### fn spec.parameters.forProvider.withRuleMixin

```jsonnet
spec.parameters.forProvider.withRuleMixin(value)
```
...
(String) The UID of the folder that the group belongs to.
The UID of the folder that the group belongs to.
###### fn spec.parameters.initProvider.withIntervalSeconds

```jsonnet
spec.parameters.initProvider.withIntervalSeconds(value)
```
...
Selector for a Organization in oss to populate orgId.
###### fn spec.parameters.initProvider.withRule

```jsonnet
spec.parameters.initProvider.withRule(value)
```
...
(Block List, Min: 1) The rules within the group. (see below for nested schema)
The rules within the group.
###### fn spec.parameters.initProvider.withRuleMixin

```jsonnet
spec.parameters.initProvider.withRuleMixin(value)
```

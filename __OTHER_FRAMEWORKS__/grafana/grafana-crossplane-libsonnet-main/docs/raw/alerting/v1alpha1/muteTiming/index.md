...
* [spec.parameters.forProvider.intervals](spec/parameters/forProvider/intervals/index.md)
* [spec.parameters.initProvider.intervals](spec/parameters/initProvider/intervals/index.md)
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withIntervals(value)`](#fn-specparametersforproviderwithintervals)
      * [`fn withIntervalsMixin(value)`](#fn-specparametersforproviderwithintervalsmixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withIntervals(value)`](#fn-specparametersinitproviderwithintervals)
      * [`fn withIntervalsMixin(value)`](#fn-specparametersinitproviderwithintervalsmixin)
...
###### fn spec.parameters.forProvider.withIntervals

```jsonnet
spec.parameters.forProvider.withIntervals(value)
```
...
###### fn spec.parameters.forProvider.withIntervalsMixin

```jsonnet
spec.parameters.forProvider.withIntervalsMixin(value)
```
...
Defaults to false. Defaults to `false`.
###### fn spec.parameters.initProvider.withIntervals

```jsonnet
spec.parameters.initProvider.withIntervals(value)
```
...
(Block List) The time intervals at which to mute notifications. Use an empty block to mute all the time. (see below for nested schema)
The time intervals at which to mute notifications. Use an empty block to mute all the time.
###### fn spec.parameters.initProvider.withIntervalsMixin

```jsonnet
spec.parameters.initProvider.withIntervalsMixin(value)
```

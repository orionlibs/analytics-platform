...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      * [`fn withAllowedOrigins(value)`](#fn-specparametersforproviderwithallowedorigins)
      * [`fn withAllowedOriginsMixin(value)`](#fn-specparametersforproviderwithallowedoriginsmixin)
      * [`fn withExtraLogAttributes(value)`](#fn-specparametersforproviderwithextralogattributes)
      * [`fn withExtraLogAttributesMixin(value)`](#fn-specparametersforproviderwithextralogattributesmixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      * [`fn withAllowedOrigins(value)`](#fn-specparametersinitproviderwithallowedorigins)
      * [`fn withAllowedOriginsMixin(value)`](#fn-specparametersinitproviderwithallowedoriginsmixin)
      * [`fn withExtraLogAttributes(value)`](#fn-specparametersinitproviderwithextralogattributes)
      * [`fn withExtraLogAttributesMixin(value)`](#fn-specparametersinitproviderwithextralogattributesmixin)
...
###### fn spec.parameters.forProvider.withAllowedOrigins

```jsonnet
spec.parameters.forProvider.withAllowedOrigins(value)
```
...
###### fn spec.parameters.forProvider.withAllowedOriginsMixin

```jsonnet
spec.parameters.forProvider.withAllowedOriginsMixin(value)
```
...
(List of String) A list of allowed origins for CORS.
A list of allowed origins for CORS.
###### fn spec.parameters.forProvider.withExtraLogAttributes

```jsonnet
spec.parameters.forProvider.withExtraLogAttributes(value)
```
...
###### fn spec.parameters.forProvider.withExtraLogAttributesMixin

```jsonnet
spec.parameters.forProvider.withExtraLogAttributesMixin(value)
```
...
###### fn spec.parameters.initProvider.withAllowedOrigins

```jsonnet
spec.parameters.initProvider.withAllowedOrigins(value)
```
...
(List of String) A list of allowed origins for CORS.
A list of allowed origins for CORS.
###### fn spec.parameters.initProvider.withAllowedOriginsMixin

```jsonnet
spec.parameters.initProvider.withAllowedOriginsMixin(value)
```
...
(List of String) A list of allowed origins for CORS.
A list of allowed origins for CORS.
###### fn spec.parameters.initProvider.withExtraLogAttributes

```jsonnet
spec.parameters.initProvider.withExtraLogAttributes(value)
```
...
(Map of String) The extra attributes to append in each signal.
The extra attributes to append in each signal.
###### fn spec.parameters.initProvider.withExtraLogAttributesMixin

```jsonnet
spec.parameters.initProvider.withExtraLogAttributesMixin(value)
```

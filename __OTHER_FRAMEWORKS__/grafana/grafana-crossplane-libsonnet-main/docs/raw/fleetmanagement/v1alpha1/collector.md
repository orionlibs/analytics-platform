...
```jsonnet
spec.parameters.forProvider.withRemoteAttributes(value)
```
...
###### fn spec.parameters.forProvider.withRemoteAttributesMixin

```jsonnet
spec.parameters.forProvider.withRemoteAttributesMixin(value)
```
...
```jsonnet
spec.parameters.initProvider.withRemoteAttributes(value)
```
...
(Map of String) Remote attributes for the collector
Remote attributes for the collector
###### fn spec.parameters.initProvider.withRemoteAttributesMixin

```jsonnet
spec.parameters.initProvider.withRemoteAttributesMixin(value)
```

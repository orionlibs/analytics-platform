...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withRealmMixin(value)`](#fn-specparametersforproviderwithrealmmixin)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withRealmMixin(value)`](#fn-specparametersinitproviderwithrealmmixin)
      * [`fn withRegion(value)`](#fn-specparametersinitproviderwithregion)
      * [`fn withScopes(value)`](#fn-specparametersinitproviderwithscopes)
      * [`fn withScopesMixin(value)`](#fn-specparametersinitproviderwithscopesmixin)
...
###### fn spec.parameters.forProvider.withRealm

```jsonnet
spec.parameters.forProvider.withRealm(value)
```
...
###### fn spec.parameters.forProvider.withRealmMixin

```jsonnet
spec.parameters.forProvider.withRealmMixin(value)
```
...
###### fn spec.parameters.forProvider.withScopes

```jsonnet
spec.parameters.forProvider.withScopes(value)
```
...
```jsonnet
spec.parameters.forProvider.withScopesMixin(value)
```
...
(String) Name of the access policy.
Name of the access policy.
###### fn spec.parameters.initProvider.withRealm

```jsonnet
spec.parameters.initProvider.withRealm(value)
```
...
(Block Set, Min: 1) (see below for nested schema)
###### fn spec.parameters.initProvider.withRealmMixin

```jsonnet
spec.parameters.initProvider.withRealmMixin(value)
```
...
cloud/developer-resources/api-reference/cloud-api/#list-regions.
Region where the API is deployed. Generally where the stack is deployed. Use the region list API to get the list of available regions: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-regions.
###### fn spec.parameters.initProvider.withScopes

```jsonnet
spec.parameters.initProvider.withScopes(value)
```
...
```jsonnet
spec.parameters.initProvider.withScopesMixin(value)
```

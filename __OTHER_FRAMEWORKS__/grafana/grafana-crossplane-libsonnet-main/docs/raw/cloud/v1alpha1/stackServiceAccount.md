...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withIsDisabled(value=true)`](#fn-specparametersforproviderwithisdisabled)
    ...
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withIsDisabled(value=true)`](#fn-specparametersinitproviderwithisdisabled)
...
Selector for a Stack in cloud to populate stackSlug.
###### fn spec.parameters.forProvider.withIsDisabled

```jsonnet
spec.parameters.forProvider.withIsDisabled(value=true)
```
...
Selector for a Stack in cloud to populate stackSlug.
###### fn spec.parameters.initProvider.withIsDisabled

```jsonnet
spec.parameters.initProvider.withIsDisabled(value=true)
```

...
* [`obj spec`](#obj-spec)
  ...
  * [`obj parameters`](#obj-specparameters)
    ...
    * [`obj forProvider`](#obj-specparametersforprovider)
      ...
      * [`fn withStackIdentifier(value)`](#fn-specparametersforproviderwithstackidentifier)
    * [`obj initProvider`](#obj-specparametersinitprovider)
      ...
      * [`fn withStackIdentifier(value)`](#fn-specparametersinitproviderwithstackidentifier)
...
###### fn spec.parameters.forProvider.withStackIdentifier

```jsonnet
spec.parameters.forProvider.withStackIdentifier(value)
```
...
use the regionSlug property: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-stacks
The region where your stack is deployed. Use the instances list API to get the region for your instance - use the regionSlug property: https://grafana.com/docs/grafana-cloud/developer-resources/api-reference/cloud-api/#list-stacks
###### fn spec.parameters.initProvider.withStackIdentifier

```jsonnet
spec.parameters.initProvider.withStackIdentifier(value)
```
